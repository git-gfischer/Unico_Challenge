...
#Usage: python3 Organize.py --dataset [PATH]
...
def main():
    ...
    val_dataset_path = os.path.join(org_dataset_path,"test")
    ...
    for (dirpath, dirnames, filenames) in os.walk(args.dataset):
        ...
        #split training and validation images for every label
        random.shuffle(filtered_images)
        test_dataset, training_dataset = train_test_split(filtered_images,test_size=0.2)
